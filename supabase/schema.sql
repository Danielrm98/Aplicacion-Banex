...
-- Permite subir la especificación (PDF) de una marca aunque esa marca
-- todavía no esté registrada como referencia del catálogo de producción.
...
-- Necesaria para que la cola de sincronización sin conexión pueda
-- reintentar una subida con el mismo nombre de archivo (upsert) tras un
-- corte de conexión a medio subir.
